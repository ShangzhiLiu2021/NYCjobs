...
This dataset has 2838 rows and 30 columns. Each row is a Job Posting from one company. Each column is one kind of information for each job posting.
...
The problem with this data is that there are some blank value, and when we work with variable "Career Level", although it shows the type of this variable is chr, one of its contents "Student" is another type and we cannot read it. 