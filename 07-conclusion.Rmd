...
## Limitation, future derection and lesson learned
From this project we learned that data processing skills and extract information ability are the foundation of data visualization. For each visualization, we spent more time on chose the right type and deal with the input data than draw the plot.
